...
export default function Home() {
  return (
    <main className="p-24 h-screen bg-gradient-to-r from-red-500 to-orange-500">
      <div className="row z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
      ...
      <div className="mb-32 row text-center lg:mb-0 lg:w-full lg:max-w-5xl lg:grid-cols-4 lg:text-left">
        <div>
          <h3>Instructions</h3>
          <p>
            Add your family members and you in the next inputs, if you need add
            another family member only click on the blue rigth button of the
            left
          </p>
        </div>
          <PrincipalForm />
